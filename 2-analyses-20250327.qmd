...
# Get model calibration
cal <- t2_cal(dat_prd, "6-month PCS", plot_s_title = "Selection")

# Get cross-validation results
cv <- t2_cv(dat_imputed, "pcs_6", "6-month PCS", selection_form_rhs, outcome_form_rhs, plot_s_title = "Selection")
...
r2 <- dat_prd %$% pseudo_r2(lps, fit[["scale"]])
 ...
 # Get model calibration
cal <- t1_cal(dat_prd, "6-month MCS")

# Get cross-validation results
cv <- t1_cv(dat_imputed, "mcs_6_t1", "6-month MCS", form_rhs)
...
# Get model calibration
cal <- t2_cal(dat_prd, "6-month MCS")

# Get cross-validation results
cv <- t2_cv(dat_imputed, "mcs_6", "6-month MCS", selection_form_rhs, outcome_form_rhs)
...
r2 <- dat_prd %$% pseudo_r2(lps, fit[["scale"]])
 ...
 # Get model calibration
cal <- t1_cal(dat_prd, "12-month PCS")

# Get cross-validation results
cv <- t1_cv(dat_imputed, "pcs_12_t1", "12-month PCS", form_rhs)
...
# Get model calibration
cal <- t2_cal(dat_prd, "12-month PCS", plot_s_title = "Selection")

# Get cross-validation results
cv <- t2_cv(dat_imputed, "pcs_12", "12-month PCS", selection_form_rhs, outcome_form_rhs, plot_s_title = "Selection")
...
r2 <- dat_prd %$% pseudo_r2(lps, fit[["scale"]])
 ...
 # Get model calibration
cal <- t1_cal(dat_prd, "12-month MCS")

# Get cross-validation results
cv <- t1_cv(dat_imputed, "mcs_12_t1", "12-month MCS", form_rhs)
...
# Get model calibration
cal <- t2_cal(dat_prd, "12-month MCS")

# Get cross-validation results
cv <- t2_cv(dat_imputed, "mcs_12", "12-month MCS", selection_form_rhs, outcome_form_rhs)
